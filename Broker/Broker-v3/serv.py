...
class SP():
	...
	def ClientUpdate(self,db_ip,db,collection,key,group_size,package_url,localhost):
		...
		#i = 8080
		#while (i <= 8089):
		#	value[i-8080] = "http://" + localhost +":"+ str(i) + "/" + "tmp.tar"
		#	i = i + 1
		#url_value[0] = "http://192.168.2.13:8080/tmp.tar"
		#url_value[1] = "http://192.168.2.13:8081/tmp.tar"
		#url_value[2] = "http://192.168.2.13:8082/tmp.tar"
		#url_value[3] = "http://192.168.2.13:8083/tmp.tar"
		#url_value[4] = "http://192.168.2.13:8084/tmp.tar"
		#url_value[5] = "http://192.168.2.13:8085/tmp.tar"
		# url_value[6] = "http://192.168.2.13:8086/tmp.tar"
		#url_value[7] = "http://192.168.2.13:8087/tmp.tar"
		#url_value[8] = "http://192.168.2.13:8088/tmp.tar"
		#url_value[9] = "http://192.168.2.13:8089/tmp.tar"
		...
		while True:
			if i >= int(group_size):
				break
			value = "http://" + localhost +":"+ str(port) +"/" + "tmp.tar"
			#port = port + 1
			#if (port > 8080):
			#	port = 8080
