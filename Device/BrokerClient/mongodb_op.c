...
char* doc_read_str(char *read_uri,char *db_name, char *collection_name, bson_t* query, const char *key_name, char* value){
...
int doc_read_int(char *read_uri,char *db_name, char *collection_name, bson_t* query, const char *key_name, int32_t value){
...
double doc_read_double(char *read_uri,char *db_name, char *collection_name, bson_t* query, const char *key_name, double value){
